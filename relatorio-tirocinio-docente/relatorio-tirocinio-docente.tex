...
\item Aprendizado de uma terminologia. Os alunos enriqueceram seu
...
Com um semestre de trabalho em basicamente dois pontos --- exposição
de idéias composicionais e escrita para quarteto de cordas --- os
alunos tiveram um bom amadurecimento em suas composições. Passaram a
ter preocupações com forma, coerência no uso dos materiais e com o
aproveitamento dos recursos dos instrumentos.
