...
dimensões, como por exemplo, altura e comprimento ao tempo
simultaneamente. Neste trabalho utilizo apenas contornos
bidimensionais. Em Música contornos podem ser associados a altura,
...
principal é construído com os contornos de 3 notas\footnote{Um
  ...
  (0 1 2), (0 2 1), (1 0 2), (1 2 0), (2 0 1), e (2 1 0). O único
  contorno ausente nesta peça é o (0 2 1).} (0 1 2), (2 0 1), (1 2 0)
e (2 1 0) e 80\% dos fragmentos melódicos do movimento derivam dos
contornos deste tema principal.
...
A classe de contornos equivalentes é um sistema classificatório
importante para a verificação de similaridade entre contornos. Dois ou
mais contornos são considerados equivalentes quando geram uma mesma
matriz de comparação, ou seja, quando mantêm a mesma estrutura de
valores entre seus elementos. Dessa forma, dado um contorno P(5 9 6
8), são considerados seus equivalentes os contornos (1 5 2 3), (0 10 4
7), (0 3 1 2) e muitos outros, pois todos eles pertencem à classe (0 3
1 2). Também são considerados contornos de classe equivalente aqueles
