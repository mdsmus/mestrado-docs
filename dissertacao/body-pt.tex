...
original, sua transposição, retrogradação, inversão, rotação e
ampliação de altura (figura \ref{fig:operacoes}). Neste exemplo defino
o contorno \code{Z}, o arquivo no qual o gráfico será criado, as
dimensões do gráfico e as operações e cores que serão geradas no
gráfico.
