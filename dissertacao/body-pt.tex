...
musical, especificamente, \eng{Music Information Retrieval}, contornos
são utilizados em sistemas \eng{query by humming} --- de busca em
...
embora seu uso não seja restrito a este tipo de atividade. Com um
sistema de controle de versão é possível trabalhar colaborativamente
sem que haja conflitos entre as versões dos arquivos dos usuários. É
possível também comparar versões de arquivos para observar as
mudanças, voltar a versões antigas para encontrar erros.
...
procedimento do usuário normalmente é registrar cada mudança feita em
um arquivo com um título e descrição, de forma que ele possa
reconhecer a mudança quando precisar.
...
em \url{git.genos.mus.br/marcos-mestrado.git}.
