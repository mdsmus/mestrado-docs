...
uma nota a cada duas, partindo-se de Sol tem-se
Sol-Mi-Dó$\sharp$-Si$\flat$. Omitindo-se duas notas a cada três tem-se
...
contorno com a omissão de uma nota a cada duas da escala octatônica, e
a figura \ref{fig:escala-secao-2-two} com a omissão de duas notas a
cada três da mesma escala.

\begin{figure}
  \centering
  \subfloat[Omissão de uma nota a cada duas]{
    \includegraphics[scale=1]{escala-secao-2-one}
    \label{fig:escala-secao-2-one}
  }

  \subfloat[Omissão de duas notas a cada três]{
