...
Os principais objetivos deste trabalho são a composição de uma obra
musical com base em combinações de operações de contorno e a produção
do seu memorial. O instrumental da obra é um quinteto de madeiras com
trompa e as operações de contorno são transposição, rotação, inversão,
retrogradação, expansão, justaposição e superposição.
