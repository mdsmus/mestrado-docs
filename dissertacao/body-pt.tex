...
elementos de valor maior que 5. Dessa forma, na falta de determinação
do conjunto universo, o contorno pode ser confinado em um sistema de
base $n+1$, onde $n$ é o maior valor numérico e a ordem de um contorno
calculada somando o seu elemento de maior valor com 1.
%% dar exemplo de base com um dos contornos V ou P
...
com operação e matriz de comparação, forma prima e classe de contorno.
...
(let ((Z #s(0 5 3 4 1 3)))
  (plot-page "contornos.pdf"
    (plot-contorno-full 50 500
       Z "original Z" :red
       (transpor Z 2) "transposição" :green
       (retrogradar Z) "retrógrado" :blue
       (inverter Z) "inversão" :orange
       (aumentar-altura Z 2) "aumentar-altura" :lightblue
...
a partir de partituras musicais em formato Lilypond e vice-versa, e
implementar uma interface gráfica. O desenvolvimento do \goiaba{}
segue procedimentos oriundos do desenvolvimento de software livre como
uso de controle de versão e disponibilização do código-fonte na
