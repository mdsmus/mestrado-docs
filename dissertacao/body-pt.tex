...
Não abordamos contornos associados à duração neste trabalho embora
...
Neste texto consideramos como operação de contorno todo tipo de
manipulação em um contorno. Dessa forma consideramos operações
...
identificadas apenas se observamos os seus contornos. Outros exemplos
de melodias de contornos semelhantes podem ser vistos nas figuras
...
``$-$'' se $b$ é  que $a$; e ``$0$'' se $b$ é igual a $a$. Por
