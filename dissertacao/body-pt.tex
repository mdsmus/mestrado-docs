...
motivo $\alpha$\footnote{Os motivos são descritos na seção
  \ref{sec:uso-de-motivos}.}. Por vezes o silêncio interrompe o
motivo, como nos na linha da flauta, nos compassos 177--178 por
exemplo (vide figura \ref{fig:grupos-separados-silencio}). O motivo é
...
Nesta quinta seção a bifonia (vide figura \ref{fig:bifonia}) é
apresentada em sua forma mais explícita. Inicialmente na região grave,
pelo clarinete e pela trompa (comp. 137--144), depois brevemente entre
oboé e trompa (comp. 146--149), e mais adiante entre flauta e
