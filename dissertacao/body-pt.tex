...
acompanhamento. Seu gestual delineia um gradual aumento de densidade e
direcionamento para o agudo. A textura contém três elementos: acentos
no fagote, clarinete e trompa; notas stacatto repetidas no fagote e
oboé; e melodia principal ocorrendo em todos os instrumentos. Esta
seção culmina no início da seção 4.
