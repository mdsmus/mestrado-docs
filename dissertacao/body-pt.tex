...
A operação de $INT_1$ do contorno principal (- + - + -) ocorre de
...
+) presente no contorno principal. Este movimento
descendente-ascendente foi inspirado em um dos toques do jogo da
