...
madeiras com trompa e as operações de contorno são transposição,
rotação, inversão, retrogradação, expansão, justaposição e
superposição.
...
analíticas aplicáveis a composições atonais que não possuem as típicas
características musicais que dão coerência a composições tonais
\cite[p. 1]{beard03:contour}. Exemplos destas características são
frases, períodos, temas e harmonia funcional.
...
que tinham intervalos melódicos e/ou ritmo eram modificados e o
contorno preservado.
...
grande conjunto de \tr{c-pitch} (alturas de contorno).
...
Contornos são representados por letras maiúsculas e têm seus elementos
representados por numerais subscritos. Estes numerais indicam a
posição destes elementos em ordem temporal
\cite{marvin.ea87:relating}. Por exemplo, um contorno $P$ de quatro
elementos tem a seguinte configuração: P(P$_0$ P$_1$ P$_3$
P$_3$). Dessa forma, dado um contorno P(5 9 6 8), P$_0$ é igual a 5,
P$_1$ é igual a 9, P$_2$ é igual a 6, e P$_3$ é igual a 8.
...
posterior e assim por diante. A diagonal INT$_1$ traz comparações de
registros entre elementos adjacentes do \tr{cseg}. Em P(5 9 6 8), por
exemplo, INT$_1=(+ - +)$, ou seja, o movimento melódico é ascendente
entre 5 e 9, descendente entre 9 e 6, e ascendente entre 6 e 8. Esta
comparação é feita também com uma operação conhecida como série de
contornos adjacentes (\tr{CAS}) \footnote{Em teorias de contornos não
  há consenso em relação a terminologia. Por isso há idéias
  semelhantes com nomes diferentes, como INT$_1$ e \tr{CAS}
