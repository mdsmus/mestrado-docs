...
fagote. Este ostinato é inspirado em um dos toques da
capoeira\footnote{A utilização deste elemento foi apenas pontual. Por
  ...
  capoeira.}. O ritmo do ostinato é aproveitado para a construção da
bifonia (vide seção \ref{sec:aspectos-verticais}). O desenho gestual
desta seção é bastante parecido ao da seção inicial, com aumento
progressivo da densidade culminando no acorde do compasso 172.
...
INT$_1$, inversão, rotações e de preenchimento de
...
a quinta seção. O padrão com as notas Sol e Lá sugere o movimento (-
+) presente no contorno principal.
