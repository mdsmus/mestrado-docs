...
compasso 9, o motivo $\alpha$ (figura \ref{fig:motivo-alpha}) aparece
...
figura \ref{fig:motivo-alpha}) dá origem aos motivos de três notas
$\beta$ (vide figura \ref{fig:motivo-beta}) e de semicolcheias
...
(letra R) e na seção final (vide seção )
