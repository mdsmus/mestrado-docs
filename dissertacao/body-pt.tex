...
é chamado de segmento de contorno (\tr{cseg})\footnote{Trata-se de uma
  ...
  espaço de contorno seria análogo à reta, e o \tr{cseg} ao segmento
  de reta.}. Para uma simplificação terminológica neste trabalho nos
referimos a segmento de contorno com o termo genérico
``contorno''. Estes \tr{cseg} podem conter elementos contíguos ou não
contíguos do espaço de contorno. Subconjuntos de \tr{cseg} são
...
o espaço de contorno contém o \tr{cseg} P, com as alturas de contorno
5, 9, 6 e 8. Na figura \ref{fig:c-space7420} o espaço de contorno
contém o \tr{cseg} M, com alturas de contorno 7, 4, 2 e 0. Ainda nesta
figura o \tr{cseg} M contém o \tr{csubseg} O, com alturas de contorno
4 e 2. Por último, na figura \ref{fig:c-space564} o espaço de contorno
contém o \tr{cseg} N, com as alturas de contorno não adjacentes 5, 6 e
4.
