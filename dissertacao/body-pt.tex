...
Para a realização deste trabalho cumpri as seguintes atividades:
...
\item Desenvolvimento de um programa de computador para processar
  ...
  dado contorno. Além disso ele permite a combinação de operações e
  sua concatenação. Este software ajudou no mapeamento e processamento
  de contornos melódicos no estudo do estado de arte, na composição
  dos experimentos, e na composição da obra final.
\end{enumerate}
...
autor. Para o presente estudo preferi criar uma definição
própria. Dessa forma entendo que contorno melódico é um conjunto
