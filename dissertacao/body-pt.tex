...
%% inserir figura como na seção 4: transição
...
seguinte (vide figura \ref{fig:transicao-sexta-dois-gestos}).

%% inserir figura comp 233 a 235 e circular fragmentos de outras
%% seções
...
%% inserir figura comp. 137 a 141 (grave)
