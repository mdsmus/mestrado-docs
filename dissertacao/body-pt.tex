...
adjacentes e altura em função do tempo. Uma definição mais precisa de
contorno envolve o conceito de espaço de contorno (c-space ou
contour-space), melhor explicado na seção \ref{sec:teor-de-cont}.
