...
autor. Para o presente estudo preferi criar uma definição própria de
que \textbf{contorno melódico é um conjunto ordenado de alturas de
  notas (chamadas de pontos) cujo valor absoluto é ignorado e somente
  o registro, que pode ser mantido ou variado ascendente e
  descendentemente entre um ponto e outro, é considerado}.
