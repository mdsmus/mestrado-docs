...
%% deixa essa informação sobre capoeira? não quero falar uma palavra
%% sobre cultura.
A quinta seção contém um ostinato na linha do fagote em toda sua
extensão. Este ostinato é baseado em um conhecido toque do jogo da
capoeira. Contornos não são usados de forma ortodoxa neste ostinato,
mas a idéia de $INT_1P$, ou seja (- + - + -), é sugerida pelo
movimento das notas $G$ e $A$.
