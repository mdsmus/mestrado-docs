...
$INT_1$, inversão, rotações e de preenchimento de contornos.

\begin{itemize}
\item Subconjunto com expansão (fagote no início)
\item Preenchimento com expansão (oboé quinta seção)
\item Rotação com expansão (sujeito do fugato e sexta seção)
\item Contorno resultante de concatenação (sujeito do fugato e
  movimentos ascendentes na sexta seção)
