...
atrelado ao aumento da amplitude (representado na figura
\ref{fig:amplitude-secao-2}) e ao estreitamento e posterior
alargamento das entradas instrumentais.

\begin{figure}
  \centering
  \includegraphics{amplitude-secao-2}
  \caption{Representação da amplitude na seção 2}
  \label{fig:amplitude-secao-2}
\end{figure}

O aumento da amplitude está associada à expansão de intervalos entre
as notas. As notas longas desta seção estão reduzidas na figura
\ref{fig:notas-secao-2}.
...
\begin{figure}
  \centering
  \includegraphics[scale=6.2]{escala-secao-2}
