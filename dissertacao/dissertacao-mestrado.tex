...
%% kroger: voz passiva fica cansativa rapido, eu sugiro "Nos podemos
%% ver representações do contorno <foo> na figura bar.
...
%% eu prefiro e termo "operação" no lugar de "ferramenta"
...
%% "Trata-se de uma abstração" esta solta e quebra o ritmo da frase
%% anterior. eu sugiro evitar "no primeiro" e "no segundo", em um
%% trabalho tecnico cheio de jargao vale a pena repetir o nome da
%% coisa.
...
\item se a subtração de $(n-1)$ pelo último \eng{\gls{cps}} é menor
...
%%% sugiro mudar o nome da macro para citacaolonga

%%% coloca-se o original em ingles no corpo do texto e a traducao no rodape.
...
\glsaddall{COM-Matrix,cps,c-space,cseg,csegclass,csubseg,i,normalform,T}
