...
\frame{
  ...
  \href{run:audio/chord.ogg}{Tocar acordes}
  \href{run:audio/dynamics.ogg}{Tocar dinâmicas}
}
...
\frame{
  ...
  \href{run:audio/motivo-alfa.ogg}{\tocar}
}
...
\frame{
  ...
  \href{run:audio/escala-secao-2-one.ogg}{\tocar}
}
...
\frame{
  ...
  \href{run:audio/secao-2.ogg}{\tocar}
}
