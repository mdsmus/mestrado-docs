...
\end{figure}
  ...
  \href{run:audio/webern-tema.ogg}{Tema}
  \href{run:audio/webern-fragmento-1.ogg}{Fr.1}
  \href{run:audio/webern-fragmento-2.ogg}{Fr.2}
}
...
\frame{
  ...
  \href{run:audio/ex-motivos-alfa-beta.ogg}{Tocar}
}
...
\frame{
  ...
  \href{run:audio/ex-motivo-gama.ogg}{Tocar}
}
...
\frame{
  ...
  \href{run:audio/interpolacao-expansao.ogg}{Tocar}
}
...
\frame{
  ...
  \href{run:audio/rotacao-expansao.ogg}{Tocar}
}
...
\frame{
  ...
  \href{run:audio/fugato.ogg}{Tocar}
...
\frame{
  ...
  \href{run:audio/secao-2-completa.ogg}{Tocar}
}
